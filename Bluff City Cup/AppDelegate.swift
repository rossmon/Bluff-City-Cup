...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        ...
        Model.sharedInstance.pushDeviceToken(token,userName:UIDevice.current.name)
    }
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.jumpstop.Bluff_City_Cup" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Bluff_City_Cup", withExtension: "momd")!
    ...
    func checkOrientation(viewController:UIViewController?)-> Int{
        ...
        }else if (viewController is MatchScorecardViewControllerNew){
