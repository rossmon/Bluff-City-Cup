...
class AddCourseMapView: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, UITextFieldDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        let newBarButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.search, target: self, action: #selector(AddCourseMapView.showSearchBar))
    ...
    @IBAction func holeInfoSavePressed(_ sender: Any) {
        ...
        if holeLength == nil || holeHandicap == nil {
            ...
            let alert = UIAlertController(title: "Oops!", message: "Enter a valid handicap and and hole length.", preferredStyle: UIAlertControllerStyle.alert)
            ...
            if holeHandicap! > 18 || holeHandicap! == 0 {
                let alert = UIAlertController(title: "Oops!", message: "Enter a handicap between 1 and 18.", preferredStyle: UIAlertControllerStyle.alert)
    ...
    @IBAction func saveCoursePressed(_ sender: Any) {
        if let courseName = courseNameField.text,
            ...
            let alert = UIAlertController(title: "Oops!", message: "Enter a correct course name, tee, and slope.", preferredStyle: UIAlertControllerStyle.alert)
