...
protocol MatchTableViewDelegate {
...
class MatchTableView: UITableViewController {
    ...
    var delegate: MatchTableViewDelegate?
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl?.addTarget(self, action: #selector(MatchTableViewController.refreshData), for: UIControlEvents.valueChanged)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(matchObject.blueTeamPlayerOne())
    }
